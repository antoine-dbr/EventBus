...
public abstract class AbstractSubscriberInfo implements SubscriberInfo {
    ...
    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType, ThreadMode threadMode,
        ...
        return createSubscriberMethod(methodName, eventType, threadMode, "", priority, sticky);
    }

    protected SubscriberMethod createSubscriberMethod(String methodName, Class<?> eventType, ThreadMode threadMode,
                                                      String backgroundThreadName, int priority, boolean sticky) {
        try {
            Method method = subscriberClass.getDeclaredMethod(methodName, eventType);
            return new SubscriberMethod(method, eventType, threadMode, backgroundThreadName, priority, sticky);
